  ...
  return (
    <div className="flex  flex-col min-h-screen bg-gradient-to-b from-blue-200 to-blue-300">
      ...
      <main className="flex-1">
        <section className="flex justify-center w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-blue-100">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-blue-800 md:text-xl">
                  Domina un nuevo idioma con TomyLanguage. Lecciones
                  interactivas, práctica de conversación y seguimiento de
        ...
        <section className="flex justify-center w-full py-12 md:py-24 lg:py-32 bg-blue-50">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="flex flex-col items-center text-center">
                <BookOpen
                  ...
                  aria-label="Lecciones interactivas"
                />
                <h3 className="text-xl font-bold mb-2 text-blue-800">
                  Lecciones interactivas
                </h3>
                <p className="text-blue-700">
                  Aprende con lecciones dinámicas y ejercicios interactivos.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                <MessageCircle
                  className="h-12 w-12 text-blue-600 mb-4"
                  aria-label="Práctica de conversación"
                />
                <h3 className="text-xl font-bold mb-2 text-blue-800">
                  Práctica de conversación
                </h3>
                <p className="text-blue-700">
                  Mejora tus habilidades de habla con nuestro asistente AI.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                <Award
                ...
                <p className="text-blue-700">
                  Monitorea tu avance y gana insignias por tus logros.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                {
                  name: "María G.",
                  text: "TomyLanguage ha transformado mi forma de aprender idiomas. ¡Es divertido y efectivo!",
                },
                {
                  name: "Carlos R.",
                  text: "Gracias a esta app, ahora puedo mantener conversaciones en inglés con confianza.",
                },
                {
                  name: "Laura S.",
                  text: "Las lecciones interactivas y el seguimiento de progreso me mantienen motivada todos los días.",
                },
        ...
        <section className="flex justify-center w-full py-12 md:py-24 lg:py-32 bg-blue-600">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[600px] text-blue-200 md:text-xl">
                  Únete a miles de estudiantes que están dominando nuevos
                  idiomas con TomyLanguage.
                </p>
              </div>
              <div className="w-full max-w-sm space-y-2">
                <Link to="/login">
                  {" "}
                  {/* Cambia el botón a un Link que dirija a /login */}
                  <button
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t border-blue-300">
        <p className="text-xs text-blue-700">
          © 2024 TomyLanguage. Todos los derechos reservados.
        </p>
        <nav className="sm:ml-auto flex gap-4 sm:gap-6">
          <a
            className="text-xs hover:underline underline-offset-4 text-blue-700"
            href="#"
          >
